...
$('#TryToContact').on('click', function () {
    alert('Regrettably, due to technical issues, we are unable to use this form. Instead, please feel free to directly send an email or try reaching out via the provided phone number.');
});